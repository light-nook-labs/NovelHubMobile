...
class NovelsByGenreScreen extends ConsumerStatefulWidget {
  ...
  const NovelsByGenreScreen({super.key, this.initialGenre});

  @override
  ConsumerState<NovelsByGenreScreen> createState() =>
      _NovelsByGenreScreenState();
}

class _NovelsByGenreScreenState extends ConsumerState<NovelsByGenreScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: NovelRankList(
        key: ValueKey('genre_${_selectedGenre}_${_selectedStatus}_${_selectedYear}_$_sortBy'),
